...
Если предпочитаете что-то более интерактивное, можете пройти [эту серию уроков на Scrimba](https://scrimba.com/g/gvuedocs), которая представляет собой сочетание скринкастов и песочницы для проверки примеров кода, где вы можете остановиться и продолжить изучение в любое время.
...
![Дерево Компонентов](/ru.vuejs.org/images/components.png)
